...
from src.models.householders import HouseholderModel
...
async def create_householder(session: AsyncSession, new_householder: HouseholderSchemaNew):
...
async def update_householder(session: AsyncSession, householder_id: int, update_data: HouseholderSchemaUpdate):
